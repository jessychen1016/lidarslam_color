  ...
  broadcaster_(this)
{
  ...
  if (registration_method == "NDT") {
	  boost::shared_ptr<pclomp::NormalDistributionsTransform<pcl::PointXYZRGB, pcl::PointXYZRGB>>
...
void GraphBasedSlamComponent::searchLoop()
{
  ...
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr latest_submap_cloud_ptr(new pcl::PointCloud<pcl::PointXYZRGB>);
  pcl::fromROSMsg(latest_submap.cloud, *latest_submap_cloud_ptr);
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr transformed_latest_submap_cloud_ptr(
  ...
  if (is_candidate) {
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr submap_clouds_ptr(new pcl::PointCloud<pcl::PointXYZRGB>);
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr filtered_clouds_ptr(new pcl::PointCloud<pcl::PointXYZRGB>());
