...
private:
    ...
    boost::shared_ptr<pcl::Registration < pcl::PointXYZRGB, pcl::PointXYZRGB >> registration_;
    ...
    std::mutex mtx_;
    pcl::PointCloud < pcl::PointXYZRGB > targeted_cloud_;
    ...
    void initializeMap(const pcl::PointCloud <pcl::PointXYZRGB>::Ptr & cloud_ptr, const std_msgs::msg::Header & header);
    void receiveCloud(
      const pcl::PointCloud < pcl::PointXYZRGB> ::ConstPtr & input_cloud_ptr,
    ...
    void convertPointCloud2ToPCL(const sensor_msgs::msg::PointCloud2::SharedPtr& input, pcl::PointCloud<pcl::PointXYZRGB>::Ptr& output);
    void convertPCLToPointCloud2(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& input,sensor_msgs::msg::PointCloud2::SharedPtr& output);
